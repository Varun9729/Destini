...
struct StoryBrain
{
    ...
    [ Story(
        ...
        c1: "I'll hop in. Thanks for the help!", c2: "Better ask him if he's a murderer first.", cd1: 2, cd2: 1
    ),
    Story(
        t: "He nods slowly, unfazed by the question.",
        c1: "At least he's honest. I'll climb in.", c2: "Wait, I know how to change a tire.", cd1: 2, cd2: 3
    ),
    Story(
        ...
        c1: "I love Elton John! Hand him the cassette tape.", c2: "It's him or me! You take the knife and stab him.", cd1: 5, cd2: 4
    ),
    Story(
